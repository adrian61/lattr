...
{
  "$end", "error", "$undefined", "T_INTEGER", "T_REAL", "ID", "';'",
  "','", "':'", "$accept", "start", "prog", "decl", "list", "type", YY_NULLPTR
};
#endif
...
{
       0,   256,   257,   258,   259,   260,    59,    44,    58
};
# endif
